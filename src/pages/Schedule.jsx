          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                name="place"
                className="form-control"
                placeholder="예: 서울 OO구장 (향후 지도 API 연동 예정)"
                value={matchInfo.place}
                onChange={handleChange}
                required
              />
            </div>
          ...
          >
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>
                  <strong>날짜:</strong> {selectedMatch.date}
                </p>
                <p>
                  <strong>시간:</strong> {selectedMatch.time}
                </p>
                <p>
                  <strong>장소:</strong> {selectedMatch.place}
                </p>
                <p>
                  <strong>경기 유형:</strong> {selectedMatch.type}
                </p>
              </div>
